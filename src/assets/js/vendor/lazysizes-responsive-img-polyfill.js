...
(function(window, document, undefined) {
    ...
    polyfill = (function() {
            ...
            for (i; i < len; i++) {
                ...
                if (candidate.d >= srces.d) {
                    if (
                        ...
                        lowerCandidate.d >
                            srces.d - 0.13 * Math.pow(srces.d, 2.2)
                    ) {
                        ...
                        if (
                            lowerCandidate.d +
                                (candidate.d - srces.d) * bonusFactor >
                            srces.d
                        ) {
            ...
            addEventListener(
                ...
                (function() {
                    ...
                    var run = function() {
                        var i, len;
                        for (
                            i = 0, len = matchMediaElems.length;
                            i < len;
                            i++
                        ) {
        ...
        var getCandidate = function(elem) {
            ...
            if (srces.isPicture) {
                for (
                    i = 0, sources = elem.parentNode.getElementsByTagName(
                        'source'
                    ), len = sources.length;
                    i < len;
                    i++
            ...
            if (
                ...
                (!(isPicture = regPicture.test(parent.nodeName || '')) &&
                    !(sizes =
                        ...
                        elem.getAttribute(lazySizesConfig.sizesAttr)))
            ) {
                return;
            }
